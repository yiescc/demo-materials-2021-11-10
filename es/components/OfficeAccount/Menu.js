...
var BtnAddSecondaryMenu = function BtnAddSecondaryMenu(_ref) {
  ...
  var _useContext = useContext(storeDispatcherCtx),
...
var SecondaryMenu = function SecondaryMenu(_ref2) {
  ...
  var _useContext2 = useContext(storeDispatcherCtx),
      chooseSecondaryMenu = _useContext2.chooseSecondaryMenu;

  var _useContext3 = useContext(storeStateCtx),
...
var MenuItem = function MenuItem(_ref3) {
  ...
  }, (_item$sub_button = item.sub_button) !== null && _item$sub_button !== void 0 && _item$sub_button.length ? /*#__PURE__*/React.createElement("span", {
    className: "wechat-office-account-menu-item-icon-more"
  }) : null, /*#__PURE__*/React.createElement("span", {
    className: "wechat-office-account-menu-item-text"
  }, item.name)), currentMenuIdx === itemIdx && /*#__PURE__*/React.createElement(SecondaryMenu, {
...
export default (function () {
  var _useContext6 = useContext(storeStateCtx),
      menu = _useContext6.menu;

  var _useContext7 = useContext(storeDispatcherCtx),
      addMenu = _useContext7.addMenu;

  return /*#__PURE__*/React.createElement("div", {
    className: "wechat-office-account-menu"
  }, /*#__PURE__*/React.createElement(BtnKeyboard, null), /*#__PURE__*/React.createElement("ul", {
