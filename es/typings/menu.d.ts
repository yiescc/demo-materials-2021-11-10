...
/** 自定义菜单按钮Item */
export declare type IMenuButtonItem = IMenuViewButtonItem | IMenuKeywordButtonItem | IMenuMiniprogramButtonItem | IMenuMessageButtonItem | IMenuParentButtonItem;
